...
def luces():
	...
	luces_Letrero = Button(luz, text="L_Letrero",width=10,height=3, command=lambda :on_offLuces(5)).place (x=210, y=40)
	luces_Garaje = Button(luz, text="L_Garaje",width=10,height=3, command=lambda :on_offLuces(4)).place (x=310, y=40)
	luces_Escalera = Button(luz, text="L_Escalera",width=10,height=3, command=lambda :on_offLuces(3)).place (x=150, y=120)
...
def todo():
       ...
       todo = Button(todo, text="ON/OFF",width=5,height=3,command= lambda :on_offLuces(6)).place (x=10, y=60)
...
def servo1():
        ...
        PuertaGaraje = Button(servo, text="Garaje",width=15,height=3,command = lambda: lambda :on_offLuces(7)).place (x=10, y=60)
